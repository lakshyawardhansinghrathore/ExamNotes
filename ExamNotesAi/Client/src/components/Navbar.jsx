  ...
  return (
    ...
    >
          ...
          <div className='flex items-center gap-3'>
            <img src={logo} alt="NoteForge" className='w-10 h-10 rounded-full' />
            <span className="text-white text-lg hidden md:block font-semibold">NoteForge <span className='text-gray-400'>AI</span>
            </span>
          </div>
          ...
          <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                 ...
                 cursor-pointer'>
                  ...
                  <motion.span whileHover={{ scale: 1.2 }} whileTap={{scale:0.95}}  
                    className='ml-2 h-5 w-5 flex items-center justify-center
                    relative rounded-full bg-white  text-xs font-bold'
                  > ➕</motion.span>
                 </motion.div>
                  ...
                  {showCredits && (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Use Credits to generate AI-powered notes
                        with diagrams and PDFs.
                      </p>
