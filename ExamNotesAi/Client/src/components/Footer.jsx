  ...
  return (
    ...
    shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
        <div className= 'grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
            ...
            style={{ transformStyle: "preserve-3d"}} >
                ...
                style = {{ transform: "translateZ(20px)" }}>
                    <img src={logo} alt="NoteForge" className='w-9 h-9 object-contain' />
                    <span className='
                    text-lg font-semibold
                    bg-gradient-to-br from-white via-gray-300 to-white
                    bg-clip-text text-transparent'
                    style={{ textShadow: "0 6px 18px rgba(0,0,0,0.4)" }}>
                        NoteForge <span className='text-gray-400'>AI</span>
                   </span>
                </div>
                <p className='text-sm text-gray-300 max-w-sm'
                style={{ transform: "translateZ(15px)", textShadow: "0 4px 12px rgba(0,0,0,0.3)" }}>
                    Your AI-powered note-taking assistant for smarter study sessions.
                </p>
            </motion.div>
            ...
            <div className='text-center'>
                ...
                <ul className='space-y-2 text-sm'>
                    ...
                    <li className='text-gray-300 hover:text-white transition-colors'>support@noteforge.com</li>
                </ul>
            </div>
        </div>
        ...
        <p className='text-center text-xs text-gray-500'>
            &copy; {new Date().getFullYear()} NoteForge AI. All rights reserved.
        </p>
