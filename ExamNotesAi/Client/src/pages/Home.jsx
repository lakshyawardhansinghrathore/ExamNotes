      ...
      lg:grid-cols-2 gap-20 items-center'>
        <div>
          ...
          >
            ...
            >
              Generate exam-focused Notes, project documents,
              flow diagrams and revision-read content using AI -
              faster, cleaner and more efficient than ever before.
      ...
      <section className='max-w-6xl mx-auto px-8 py-32 grid grid-cols-1
       md:grid-cols-4 gap-10'>
        <Feature
          ...
          des="High quality, exam-focused notes with revision-ready points, diagrams and more."
        />
        <Feature icon=
        "📁" title="Project Notes" des="Generate structured project notes, documentation and flow diagrams in seconds." />
        <Feature icon="📊" title="Charts & Graphs" des="Auto-create flowcharts, mind maps, diagrams and visual notes with AI." />
        <Feature icon="⬇️" title="Free PDF Download" des="Download clean, printable PDFs of your notes instantly." />
      </section>
...
function Feature({ icon, title, des }) {
  return (
    <motion.div
      ...
      backdrop-blur-2xl
      border border-white/10
      shadow-[0_30px_85px_rgba(0,0,0,0.7)]
      text-white'
      style={{ transformStyle: "preserve-3d" }}
    >
